...
/// <summary>
/// The cannon ball handles it's own collision with object and deals damage to everything with the IDamagable class
/// </summary>
...
public class CannonBall : MonoBehaviour
{
    ...
    /// <summary>
    /// Deals damage when hitting an object with the IDamageable class or splashes when entering the water
    /// </summary>
