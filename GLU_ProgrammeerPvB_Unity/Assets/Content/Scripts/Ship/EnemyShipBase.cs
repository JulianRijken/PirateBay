...
/// <summary>
/// Handles the enemy ships AI and uses the ship class of the backend
/// </summary>
public class EnemyShipBase : Ship
{
    ...
    /// <summary>
    /// Destroys the ship and invokes an event when the ship sinks
    /// </summary>
    ...
    /// <summary>
    /// Calls HandleAI() if the ship is not sunk
    /// </summary>
    ...
    /// <summary>
    /// Handles the AI for the enemy ship
    /// </summary>
