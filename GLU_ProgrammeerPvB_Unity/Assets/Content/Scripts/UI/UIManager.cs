...
/// <summary>
/// Manages all the UI in the game like:
/// Handles switching between the GUI and the menu screens,
/// Reacts to events from the player, GameManger and MissionManager to keep all the UI up to date,
/// Handles the interaction between the UI button component and the code.
/// </summary>
public class UIManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Shows the GUI and locks cursor
    /// </summary>
    ...
    /// <summary>
    /// Switches screen to the game over screen and show cursor
    /// </summary>
